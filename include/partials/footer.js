...
module.exports= function (hbs) {
	...
	var footer = '<footer class="mdl-mini-footer">';
	    ...
	    footer += '<a href="http://nckunetdb.appspot.com">NCKU-NetDB</a>';
	    ...
	    footer += '</div>';
 			...
 			footer += '<span class="footer_msg">商業合作提案、客製化圖表製作、意見回饋</span></a>歡迎來信: <a href="mailto:contact@taiwanstat.com">contact@taiwanstat.com</a></div>';
 			footer += '</footer>';
